...
(function($) {
    ...
    $.fn.activebar.defaults = {
        ...
        'fontSize': '11px',
        'icons_path' : '/images/',
        'url': 'http://www.realalehunter.co.uk/pages/ie6_needs_to_die',
        'preload': true
    };
...
jQuery(document).ready(function($) {
  $('<div></div>').html('Your browser is not supported. Click for more details and information on how to upgrade')
